...
$string['enablesecondpage_help'] = 'Enable Certificate Back page edition, if is disabled, only certificate QR code will be printed in back page (if the QR code is enabled)';$string['eventcertificate_issued'] = 'Certificate issued';
$string['eventcertificate_issued_description'] = 'The user with id {$a->userid} issued the certificate with id {$a->certificateid} (code: {$a->code}) to user with id {$a->relateduserid} in course with id {$a->courseid}.';$string['eventcertificate_verified'] = 'Certificate verified';
